...
def get_ae_2x2(inputs):
    ...
    #encoder
    conv1 = Conv2D(8, (5, 5), strides=(1,1), activation='relu', padding='same')(inputs)
    pool1 = MaxPooling2D(pool_size=(5, 5))(conv1) #25 x 25 x 16
    conv2 = Conv2D(8, (5, 5), strides=(1,1), activation='relu', padding='same')(pool1)
    ...
    conv5 = Conv2D(8, (3, 3), strides=(2,2), activation='relu', padding='same')(pool4)
    ...
    conv8 = Conv2DTranspose(8, (5, 5), strides=(1,1), activation='relu', padding='same')(up3) # 100 x 100 x 8
    up4 = UpSampling2D((5,5))(conv8) # 400 x 400 x 8
    conv9 = Conv2DTranspose(8, (5, 5), strides=(1,1), activation='relu', padding='same')(up4) # 100 x 100 x 8
...
def get_ae_4x4(inputs):
    ...
    conv4 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool3)
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4) #25 x 25 x 16
    conv5 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool4)
...
def get_ae_16x16(inputs):
    ...
    conv8 = Conv2DTranspose(8, (5, 5), strides=(1,1), activation='relu', padding='same')(conv3) # 100 x 100 x 8
    up4 = UpSampling2D((5,5))(conv8) # 400 x 400 x 8
    conv9 = Conv2DTranspose(8, (5, 5), strides=(1,1), activation='relu', padding='same')(up4) # 100 x 100 x 8
    up5 = UpSampling2D((5,5))(conv9) # 400 x 400 x 8
    decoded = Conv2DTranspose(1, (3, 3), strides=(1, 1), activation='relu', padding='same')(up5)
...
def get_ae_5x5(inputs):
    ...
    #encoder
    conv1 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(inputs)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1) #25 x 25 x 16
    conv2 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool1)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2) #25 x 25 x 16
    conv3 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool2)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3) #25 x 25 x 16
    conv4 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool3)
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4) #25 x 25 x 16   
    conv5 = Conv2D(8, (5, 5), strides=(5,5), activation='relu', padding='same')(pool4)
    ...
    conv8 = Conv2DTranspose(8, (3, 3), strides=(1,1), activation='relu', padding='same')(up2) # 100 x 100 x 8
    up3 = UpSampling2D((2,2))(conv8) # 400 x 400 x 8
    conv9 = Conv2DTranspose(8, (3, 3), strides=(1,1), activation='relu', padding='same')(up3) # 100 x 100 x 8
...
def get_ae_100x100(inputs):
    ...
    conv3 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool2)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3) #25 x 25 x 16
    conv5 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool3)
...
def get_ae_200x200(inputs):
    ...
    conv1 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(inputs)
    conv2 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(conv1)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2) #25 x 25 x 16
    conv5 = Conv2D(8, (3, 3), strides=(1,1), activation='relu', padding='same')(pool2)
...
for i in range(8):
    ...
    if autoencoder is not None:
        ...
        autoencoder.save("model_cnn_all_filter_8_run" + str(i) + ".h5")
        ...
        plt.savefig("cnn_all_filter_8_loss_run" + str(i) + ".png")
        plt.close()
