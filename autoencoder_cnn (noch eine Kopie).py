...
def get_autoencoder(inputs):                             
    ...
    #encoder
    conv1 = Conv2D(16, (4, 4), strides=(2,2), activation='relu', padding='same')(inputs)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1) #25 x 25 x 16
    conv2 = Conv2D(8, (4, 4), strides=(2,2), activation='relu', padding='same')(pool1)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2) #25 x 25 x 16
    conv3 = Conv2D(1, (4, 4), strides=(1,1), activation='relu', padding='same')(pool2)
    print(conv3.shape)
    ...
    conv5 = Conv2DTranspose(8, (4, 4), strides=(2,2), activation='relu', padding='same')(conv3) # 100 x 100 x 8
    up2 = UpSampling2D((2,2))(conv5) # 400 x 400 x 8
    conv6 = Conv2DTranspose(16, (4, 4), strides=(2,2), activation='relu', padding='same')(up2) # 100 x 100 x 8
    #up3 = UpSampling3D((1,2,2))(conv6) # 400 x 400 x 8
    decoded = Conv2DTranspose(1, (4, 4), strides=(2, 2), activation='relu', padding='same')(conv6)
    return decoded
